...
use core::slice;
use rayboot::arch::x86_64::SystemInfo;
use rayboot::boot_info::{FrameBufferInfo, PixelFormat};
...
global_asm!(include_str!("../arch/x86_64/asm/stage_1.s"));
global_asm!(include_str!("../arch/x86_64/asm/stage_2.s"));
global_asm!(include_str!(concat!(env!("OUT_DIR"), "/vesa_config.s")));
global_asm!(include_str!("../arch/x86_64/asm/vesa.s"));
global_asm!(include_str!("../arch/x86_64/asm/e820.s"));
global_asm!(include_str!("../arch/x86_64/asm/stage_3.s"));
...
fn bootloader_main(
    ...
    rayboot::arch::x86_64::load_and_switch_to_kernel(
        kernel,
        frame_allocator,
        page_tables,
        system_info,
...
fn init_logger(
    ...
    let info = rayboot::boot_info::FrameBufferInfo {
    ...
    rayboot::arch::x86_64::init_logger(slice, info);
...
) -> rayboot::arch::x86_64::PageTables {
...
fn panic(info: &PanicInfo) -> ! {
    unsafe {
        rayboot::arch::x86_64::logger::LOGGER
            .get()
