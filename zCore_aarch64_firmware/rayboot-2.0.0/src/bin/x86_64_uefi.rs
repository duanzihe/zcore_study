...
use rayboot::arch::x86_64::logger;
use rayboot::arch::x86_64::{
    legacy_memory_region::LegacyFrameAllocator, load_and_switch_to_kernel, parsed_config::CONFIG,
    SystemInfo,
};
use rayboot::boot_info::FrameBufferInfo;
...
fn efi_main(image: Handle, st: SystemTable<Boot>) -> Status {
    ...
    load_and_switch_to_kernel(&KERNEL.0, frame_allocator, page_tables, system_info)
}
...
fn init_logger(st: &SystemTable<Boot>) -> (PhysAddr, FrameBufferInfo) {
    ...
    let info = FrameBufferInfo {
        ...
        pixel_format: match mode_info.pixel_format() {
            PixelFormat::Rgb => rayboot::boot_info::PixelFormat::BGR,
            PixelFormat::Bgr => rayboot::boot_info::PixelFormat::BGR,
