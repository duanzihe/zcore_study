...
pub use crate::boot_info::{Aarch64BootInfo, BootInfo, FirmwareType};
...
compile_error!("This crate only supports the x86_64 or aarch64 architecture.");
...
macro_rules! entry_point {
    ($path:path) => {
        #[export_name = "_start"]
        pub extern "C" fn __impl_start(boot_info: &$crate::boot_info::Aarch64BootInfo) -> ! {
            // validate the signature of the program entry point
            let f: fn(&$crate::boot_info::Aarch64BootInfo) -> ! = $path;
